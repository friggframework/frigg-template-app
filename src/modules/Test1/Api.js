...
class Test1API extends OAuth2Base {
    constructor(params) {
        super(params);

        this.baseUrl = '';

        this.client_id = process.env.TEST1_CLIENT_ID;
        this.client_secret = process.env.TEST1_CLIENT_SECRET;
        this.redirect_uri = `${process.env.TEST1_REDIRECT_URI}`;
        this.scopes = process.env.TEST1_SCOPE;
