...
class IntegrationList extends Component {
	...
	render() {
		...
		if (this.props.integrations) {
			...
			console.log('integrationUtils.getPossibleIntegrations()', integrationUtils.getPossibleIntegrations());
		}
		if (integrationUtils) {
			displayedIntegrations = this.renderCombinedIntegrations(
				integrationUtils.getActiveAndPossibleIntegrationsCombined()
			);
			console.log('getActiveAndPossibleIntegrationsCombined', integrationUtils.getActiveAndPossibleIntegrationsCombined());
